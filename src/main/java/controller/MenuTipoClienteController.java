...
public class MenuTipoClienteController {
    public void clickButtomClienteTipoPersona(ActionEvent actionEvent) {
        try {
            ...
            e.printStackTrace();
            mostrarAlerta("Error", "No se pudo cargar el menú de mantenimiento clientes de tipo persona", Alert.AlertType.ERROR);
        }
    }

    public void clickButtomClienteTipoEmpresa(ActionEvent actionEvent) {
        try {
            // Cargamos la vista del menú principal
            ...
            e.printStackTrace();
            mostrarAlerta("Error", "No se pudo cargar el menú de mantenimiento clientes de tipo empresa.", Alert.AlertType.ERROR);
        }
    }
